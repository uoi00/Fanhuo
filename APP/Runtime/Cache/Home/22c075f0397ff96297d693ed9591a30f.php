...
<div id="atc_frame">
    <?php if(is_array($data)): foreach($data as $key=>$vo): ?><div class="article">
            <div class="atc_head">
                <div class="atc_name">
                    <?php echo ($vo["title"]); ?>
                </div>
                <div class="atc_time"><?php echo ($vo["ctime"]); ?></div>
            </div>
            <hr>
            <div class="atc_body">
                <?php echo ($vo["body"]); ?>
            ...
            <div class="atc_btm">
                <button class="btn btn-xs btn-danger btndel" id="<?php echo ($vo["id"]); ?>">删除</button>
            </div>
